...
for symbol in trading_symbols:
    path = '{}/data/base/u_heyue/1h/{}_u_heyue_1h.csv'.format(os.path.dirname(os.path.realpath('__file__')), symbol)
    if not os.path.exists(path):
        ...
        df = data_loader.download_symbol_historty_kline(symbol, '1h', 
        ...
        incr_df = data_loader.download_symbol_historty_kline(symbol, '1h', '{} hour ago UTC'.format(query_start_minutes), '0 hour ago UTC', conf_type='u_heyue', maxLimit=1500)
