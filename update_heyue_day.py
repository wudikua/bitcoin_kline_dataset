...
for symbol in trading_symbols:
    path = '/root/bt_fund/data/base/u_heyue/1d/{}_u_heyue_1d.csv'.format(symbol)
    if not os.path.exists(path):
        ...
        df = data_loader.download_symbol_historty_kline(symbol, '1d', 
        ...
        incr_df = data_loader.download_symbol_historty_kline(symbol, '1d', '{} day ago UTC'.format(query_start_minutes), '0 day ago UTC', conf_type='u_heyue', maxLimit=1500)
